    ...
    el.innerHTML = `
      <div class="cf-card etl-card" data-etl-card="prompt">
        <div class="cf-card-head">
          ...
          <span class="cf-card-title etl-card-title active" id="st1" data-i18n="etl_card_prompt">選擇分析任務</span>
        ...
        <div class="cf-card-body etl-card-body" id="stepSection1">
          ...
          <label class="field-label" style="margin-top:12px" data-i18n="etl_prompt_label">分析任務（可手動修改）</label>
          <div class="prompt-stack" id="promptList">
            <div class="prompt-empty" data-i18n="etl_prompt_helper">選取上方 Prompt 後，可在這裡直接微調本次送出的內容</div>
          </div>
        </div>
      </div>
    `.trim();
