...
const ETLCard4Block = {
  render(container) {
    ...
    el.innerHTML = `
      <div class="etl-step-group" data-etl-card="run">
        <div class="etl-timeline">
          <div class="etl-num">04</div>
          <div class="etl-vline"></div>
        </div>
        <div class="etl-body">
          <div class="etl-card-head">
            <span class="etl-label" id="st2">執行萃取</span>
            <button class="btn btn-ghost btn-xs" data-etl-toggle="run">隱藏</button>
          </div>
          <div class="etl-card-body section" id="stepSection2">
